...
import com.pixel.basic.service.RoleMenuServiceImpl;
import com.pixel.basic.service.RoleService;
import com.pixel.basic.tools.PinyinToolkit;
import com.pixel.basic.tools.TokenTools;
import com.pixel.basic.utils.PageableUtil;
import com.pixel.basic.utils.ParamFilterUtil;
...
public class RoleController {
    ...
    public String menus(Model model, @PathVariable Integer id, HttpServletRequest request) {
        ...
        List<Integer> curAuthList = roleService.listRloeMenuIds(id);
